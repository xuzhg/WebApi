...
namespace System.Web.OData.Properties {
    ...
    internal class SRResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The swagger model could not be found. The related swagger model is required to serialize the payload..
        /// </summary>
        internal static string SwaggerModelMissingDuringSerialization {
            get {
                return ResourceManager.GetString("SwaggerModelMissingDuringSerialization", resourceCulture);
            }
        }
